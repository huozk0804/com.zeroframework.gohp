...
namespace ZeroFramework.Editor.Package
{
    ...
    public class AgentEditor : UnityEditor.Editor
    {
        public override VisualElement CreateInspectorGUI()
        {
            ...
            root.Add(new PropertyField(serializedObject.FindProperty("<ActionProviderBase>k__BackingField")));
            root.Add(new PropertyField(serializedObject.FindProperty("isPaused")));
            ...
            var agent = (AgentBehaviour) target;
