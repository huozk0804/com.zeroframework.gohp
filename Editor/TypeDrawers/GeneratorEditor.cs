...
namespace ZeroFramework.Editor.Package
{
    ...
    public class GeneratorEditor : UnityEditor.Editor
    {
        ...
        {
            var scriptable = (GeneratorScriptable) target;
            
            var root = new VisualElement();

            root.Add(new PropertyField(serializedObject.FindProperty("nameSpace")));
            
            var goals = CreateTextField(root, "Goals");
            var actions = CreateTextField(root, "Actions");
            var worldKeys = CreateTextField(root, "WorldKeys");
            var targetKeys = CreateTextField(root, "TargetKeys");
